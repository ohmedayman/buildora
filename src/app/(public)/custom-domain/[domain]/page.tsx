  ...
  return (
    <html lang="ar" dir="rtl">
      <head>
        ...
        {page.analytics_code && <div dangerouslySetInnerHTML={{ __html: page.analytics_code }} />}
      </head>
